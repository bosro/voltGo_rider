...
export default function WithdrawScreen() {
  ...
  const handleWithdraw = () => {
    if (!isValid) {
      toast.error(
        `Minimum withdrawal is GHS 10.00. Available: GHS ${AVAILABLE_BALANCE.toFixed(2)}.`,
      );
      return;
    }
    setShowConfirm(true);
      ...
      >
        ...
        <View style={styles.balanceCard}>
          ...
          <Text style={styles.balanceAmount}>
            GHS {AVAILABLE_BALANCE.toFixed(2)}
          </Text>
        </View>
        ...
        <View style={styles.chipsRow}>
          {QUICK_AMOUNTS.map((q) => (
            <TouchableOpacity
              ...
              style={[
                styles.chip,
                amount === q.toString() && styles.chipActive,
              ]}
            ...
            >
              <Text
                style={[
                  styles.chipText,
                  amount === q.toString() && styles.chipTextActive,
                ]}
              >
                GHS {q}
              </Text>
        ...
        <Text style={styles.feeNote}>
          No withdrawal fees • Instant for MoMo • 1–2 days for bank
        </Text>
...
const styles = StyleSheet.create({
  ...
  modalOverlay: {
    flex: 1,
    backgroundColor: "rgba(13,34,64,0.5)",
    alignItems: "center",
