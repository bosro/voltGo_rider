...
type Tx = { id: string; type: TxType; description: string; amount: number; date: string; time: string };
type TxSection = { title: string; data: Tx[] };

const ALL_DATA: TxSection[] = [
  { title: 'June 2026', data: [
    { id:'t1', type:'earning', description:'Delivery · American House → UG', amount:24, date:'5 Jun', time:'14:32' },
    { id:'t2', type:'withdrawal', description:'Withdrawal · MTN MoMo ****04', amount:-250, date:'4 Jun', time:'09:00' },
    { id:'t3', type:'earning', description:'Delivery · Madina → Legon', amount:44, date:'3 Jun', time:'11:15' },
    { id:'t4', type:'earning', description:'Delivery · East Legon → Airport', amount:38, date:'2 Jun', time:'16:50' },
  ]},
  { title: 'May 2026', data: [
    { id:'t5', type:'earning', description:'Delivery · American House → UG', amount:20, date:'30 May', time:'13:10' },
    { id:'t6', type:'withdrawal', description:'Withdrawal · MTN MoMo ****04', amount:-500, date:'28 May', time:'08:45' },
    { id:'t7', type:'earning', description:'Delivery · Madina Old Station', amount:14, date:'26 May', time:'10:20' },
    { id:'t8', type:'earning', description:'Delivery · East Legon Americana', amount:44, date:'25 May', time:'15:05' },
    { id:'t9', type:'earning', description:'Delivery · University of Ghana', amount:50, date:'22 May', time:'09:30' },
  ]},
];
      ...
      <SectionList
        ...
        renderItem={({ item }) => (
          <View style={styles.row}>
            <SvgXml xml={item.type === 'earning' ? earningIconSvg : withdrawIconSvg} width={36} height={36} />
            <View style={styles.rowText}>
              <Text style={styles.rowDescription} numberOfLines={1}>{item.description}</Text>
              <Text style={styles.rowDate}>{item.date} · {item.time}</Text>
            </View>
            <Text style={[styles.rowAmount, item.type === 'earning' ? styles.earning : styles.withdrawal]}>
        ...
        ListEmptyComponent={
          <View style={styles.empty}>
            ...
            <Text style={styles.emptyText}>No {filter.toLowerCase()} found</Text>
          </View>
        }
      />
    </SafeAreaView>
...
const styles = StyleSheet.create({
  ...
  filtersRow: { flexDirection: 'row', paddingHorizontal: 22, gap: 10, marginBottom: 8 },
  filterChip: { borderWidth: 1.5, borderColor: Colors.border, borderRadius: Radius.full, paddingHorizontal: 18, paddingVertical: 8 },
  filterChipActive: { backgroundColor: Colors.navy, borderColor: Colors.navy },
  filterText: { fontFamily: 'Poppins-Regular', fontSize: Typography.sm, color: Colors.textSecondary },
  ...
  rowText: { flex: 1 },
  rowDescription: { fontFamily: 'Poppins-SemiBold', fontSize: Typography.base, color: Colors.textPrimary, marginBottom: 2 },
  rowDate: { fontFamily: 'Poppins-Regular', fontSize: Typography.sm, color: Colors.textMuted },
  rowAmount: { fontFamily: 'HelveticaNeue-CondensedBold', fontSize: Typography.lg },
